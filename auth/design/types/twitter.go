...
var TwitterRegisterMedia = MediaType("twitter-register-media", func() {
	Description("Information used to pre-populate the register page")
	ContentType("application/json")
	Attributes(func() {
		Attribute("email", String, "An email extracted from the Twitter account")
		Attribute("firstName", String, "The given name for the user, pulled from the Twitter account", func() {
			Example("Jeff")
		})
		Attribute("lastName", String, "The family name for the user, pulled from the Twitter account", func() {
			Example("Newmann")
		})
...
var TwitterRegisterParams = Type("twitter-register-params", func() {
